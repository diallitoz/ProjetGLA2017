...
<title>Confirmation de creation de l'utilisateur ${user.id}</title>
...
<div class=" panel panel-primary">
			...
			<div class=" panel-heading">Confirmation de la creation du nouveau Utilisateur</div>
			<div class=" panel-body">
				...
				<div class="form-group">
					<label> Profil :  </label> <label> ${user.profil}</label>
				</div>

				<div class="form-group">
					<label> Login :  </label> <label> ${user.login}</label>
				</div>
				...
				<div class="form-group">
					<label> Status :  </label> <label>	${user.status}</label>
				</div>		
