...
<div class=" panel panel-primary">
			...
			<div class=" panel-heading">Modification des informations de client</div>
			<div class=" panel-body">
				<form action="ModificationClient.php" method="post">
					<div class="form-group">
						<label class=" control-label "> Id </label> 
						<input type="hidden" name="id" class="form-control" value = "${client.id }" required = "required" /> <span></span>
					...
					<div class="form-group">
						...
						<input type="text"	name="email" id="email" class="form-control" value = "${client.email }" required = "required" /> <span></span>
					</div>
