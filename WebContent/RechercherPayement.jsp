...
<title>Historiques des payements</title>
...
<div class=" panel panel-primary">
			...
			<div class=" panel-heading">Historiques des payements</div>
			<div class=" panel-body">

				<form action="HistoriquePayement.php" method="get">
				...
				<table style="border:1px" class="table table-striped" >
					...
					<c:forEach items="${modelePayement.listePayementRecherche}" var="payement">
						<tr>
							...
							<td>${payement.idCompteBeneficiaire }</td>
